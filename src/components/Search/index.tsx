...
const Search:React.FC = () => {
    ...
    const {
        value: enteredNeoId,
        hasError: neoIdInputHasError,
        isValid: enteredNeoIdIsValid,
        valueChangeHandler: neoIdChangedHandler,
        inputBlurHandler: neoIdBlurHandler,
    } = useInput(isNotEmpty);
                    ...
                    <div className="flex w-full justify-center">
                        <div className="mt-1 flex w-full md:w-1/2 rounded-md shadow-sm">
                            ...
                            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                ...
                                <input type="text" value={enteredNeoId} onBlur={neoIdBlurHandler} onChange={neoIdChangedHandler} className="block w-full rounded-none rounded-l-md border-gray-300 pl-10 focus:border-primary-500 focus:ring-primary-500 sm:text-sm" placeholder="NEO ID" />
                            </div>
                            <button type="submit"  disabled={!formIsValid}  className="relative -ml-px inline-flex items-center space-x-2 rounded-r-md border border-gray-300 bg-gray-50 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500">
