...
const AsteroidListItem:React.FC<Props> = (props) => {
    ...
    return (
        <tr className="divide-x divide-primary-500 hover:bg-gray-600">
            <td className="whitespace-nowrap py-4 pl-4 pr-4 text-sm md:text-base font-medium text-primary-500 hover:underline sm:pl-6 text-center"><Link to={`/asteroid/${props.id}`}>{props.id}</Link></td>
